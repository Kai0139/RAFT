...
python3 -u train.py --name raft-chairs-4x --stage chairs --validation chairs --gpus 0 1 2 3 --num_steps 10000 --batch_size 6 --lr 0.000125 --image_size 368 496 --wdecay 0.00001 --gamma=0.85 --small
